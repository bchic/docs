...
<Note>
    Bei bedingungsbasierten Filtern können Sie über den **REGEX-Operator** reguläre Ausdrücke verwenden, um mehrere Varianten in einer einzigen Bedingung abzudecken (z.B. mehrere URL-Muster). Über das Feld `Alle` lässt sich zudem ein Begriff feldübergreifend suchen.
</Note>
