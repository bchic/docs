...
<Note>
    Die Google-Search-Performance-Daten stammen aus der [Google Search Console Integration](de/settings/google-search-console) und stehen ab dem Growth-Plan zur Verfügung.
</Note>

> **MCP:** Die Impact-Wirkungsdaten sind auch über den MCP-Server abrufbar – du kannst sie also per natürlicher Sprache in Claude oder Cursor abfragen. Siehe [Verfügbare Tools & Fragen](/de/plattform/ai/mcp-tools).
