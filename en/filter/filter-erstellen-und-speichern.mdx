...
<Note>
    For condition-based filters you can use the **REGEX operator** to cover multiple variations in a single condition (e.g. several URL patterns). The `All` field additionally lets you search a term across all fields at once.
</Note>
