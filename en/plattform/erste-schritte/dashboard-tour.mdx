...
<Tip>
    The sidebar is customizable: depending on your role you can reorder your own navigation – and admins set a default navigation per role. Learn more in the [Sidebar Customizer](/en/settings/admin/sidebar-customizer).
</Tip>
