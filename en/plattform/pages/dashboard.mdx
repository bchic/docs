...
### Countries Widget with Map View

Alongside the list, the countries widget offers a **map view** that displays your traffic geographically. Via the expandable **fullscreen view** you see the list and the map side by side, letting you explore the distribution of your visitors in even more detail.

### Version Drilldown for Browser & OS

The breakdown by **browser** and **operating system** can now be expanded down to the individual **version**. This shows you, for example, which Chrome or iOS version your visitors use. Newly appearing versions are highlighted with a **"New" badge**.

### "Google" Tab in the Sources Widget

The sources widget includes an additional **"Google" tab** showing the data from [Google Search Console](en/settings/google-search-console) – alongside the existing tabs for sources, channels, UTM campaigns, and outbound links.
